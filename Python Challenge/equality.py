...
for string in range(0,len(strlist)):
    ...
    for char in range(0,len(strlist[string])):
        #check if current character is lowercase
        if strlist[string][char].islower():
            try:
                if strlist[string][char+1].isupper():
                    E = True
                    if strlist[string][char-1].isupper():
                        W = True
                        if strlist[string][char+2].isupper():
                            E2 = True
                            if strlist[string][char-2].isupper():
                                W2 = True
                                if strlist[string][char+3].isupper():
                                    E3 = True
                                    if strlinst[string][char-3].isupper():
                                        W3 = True
                                        temp += strlist[string][char]
            except:
                IndexError
print((char_frequency(temp)))
print("###DONE####")
